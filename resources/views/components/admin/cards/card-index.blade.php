        ...
        <div class="p-6 rounded-2xl color-primario">
            <div class="mb-5">
                <div class="flex gap-1">
                    ...
                    <button type="button" class="ml-auto -mx-4 -my-4 bg-gray-100 text-gray-500 rounded-full p-1.5 inline-flex h-8 w-8 hover:bg-red-300 hover:text-red-500 transition-all" data-dismiss-target="#alert" aria-label="Close" onclick="closeAlert(event)">
