    ...
    <div class="py-6">
        <div class="container">
            <div class="p-2">
                ...
                <p class="text-sm text-gray-500">Editando: <span class="font-bold">{{ $quater->name }}</span></p>
                <p class="text-sm text-gray-500">&Uacute;ltima modificaci&oacute;n: <span class="font-bold">{{ $quater->updated_at }}</span></p>
                @if (session('info'))
