<div>
    ...
    <div class="mb-2 flex justify-end">
        <div class="relative mt-1 w-full sm:w-1/3">
            ...
            <input wire:model="search" type="text" class="w-full p-2 pl-10 text-sm text-gray-700 leading-5 py-2 px-3 border-4 border-gray-600 text-white-500 rounded-lg shadow-sm focus:outline-none dark:text-white-400 dark:placeholder:text-white-600 dark:bg-white dark:border-gray-500 transition ease-in-out " placeholder="Buscar..." id="txtBuscar" name="txtBuscar">
        </div>
    </div>
