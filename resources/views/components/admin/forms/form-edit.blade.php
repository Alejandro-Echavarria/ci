...
<div class="grid grid-cols-{!! $class['col'] !!} sm:grid-cols-{!! $class['col'] !!} gap-3">
    @foreach ($fields as $field)
        <div>
            ...
            <input 
                ...
                {{($errors->has($field['name-attribute']) ? ' border-red-400 dark:border-red-400/60 placeholder-red-700 focus:ring-red-500 focus:border-red-500 text-red-500' : null)}}"
