<div>
    ...
    <div class="mb-2 justify-end">
        <div class="flex w-full justify-between aling">
            <a href="{{route('admin.grades.create')}}" class="px-5 py-2.5 mr-2 mt-1 text-white color-secundario focus:outline-none font-medium rounded-2xl text-sm w-auto text-center dark:hover:bg-blue-700 cursor-pointer">
                <i class="fas fa-plus"></i> <span class="hidden-letters font-weight-bold"> Agregar</span>
            </a>
            <div class="relative mt-1 w-full sm:w-1/3">
                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                    ...
                    <input wire:model="search" type="search" class="w-full p-2 pl-10 text-sm text-gray-700 py-2 px-3 border-4 border-gray-600 text-white-500 rounded-2xl focus:outline-none dark:text-white-400 dark:placeholder:text-white-600 dark:bg-white focus:ring-gray-800 focus:ring-0  transition ease-in-out" placeholder="Buscar: ej. yyyy-mm-dd" id="txtBuscar" name="q">
                </div>
            </div>
        </div>
