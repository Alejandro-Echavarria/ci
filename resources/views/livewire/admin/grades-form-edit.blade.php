    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 gap-3 mb-3">
        ...
        <div>
            ...
            <input
                ...
                id="name" 
                name="name" 
                class="w-full p-2.5 text-sm text-gray-700 border-1 border-gray-300/20 rounded-xl focus:outline-none focus:ring focus:ring-gray-500/20 focus:border-gray-400/20 placeholder:text-gray-500 backdrop-blur-sm bg-gray-300/20 transition ease-in-out {{($errors->has('name') ? ' border-red-400/20  placeholder-red-700 focus:ring-red-500 focus:border-red-500 text-red-500' : null)}}"
                value="{{ old('name') }}"
                ...
                <div>
                    <div class="flex gap-3">
                        ...
                        <select 
                            ...
                            class="w-full p-2.5 text-sm text-gray-700 border-1 border-gray-300/20 rounded-xl focus:ring focus:ring-gray-500/20 focus:border-gray-400/20 focus:outline-none placeholder:text-gray-500 backdrop-blur-sm bg-gray-300/20 transition ease-in-out {{($errors->has('subjects.'.$key.'.grade_id') ? ' border-red-400/20 placeholder-red-700 focus:ring-red-500  focus:border-red-500 text-red-500' : null)}}">
