    ...
    <div class="flex w-full justify-between">
        ...
        <div class="bg-gradient-to-r from-gray-600 to-blue-700 rounded-xl text-center cursor-default mt-1 p-1 w-full sm:w-auto">
            <div class="backdrop-blur-sm bg-white/10 rounded-lg focus:outline-none px-5 py-1 h-full">
                <span id="ic" class="text-white font-medium text-sm" title="Indice acumulado">Indice acumulado:
        ...
        @foreach ($records as $record)
            ...
            <div class="p-6 rounded-2xl color-primario">
                ...
                <div class="flex justify-between">
                    <a href="{{ route('admin.quaters.edit', $record) }}" class="text-white color-secundario focus:outline-none font-medium rounded-xl text-sm px-5 py-2.5 text-center dark:hover:bg-blue-700 cursor-pointer transition ease-in-out">
                        Editar
                    </a>
                    @if ($record->subjects->count())
